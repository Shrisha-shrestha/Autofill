...
class _CustomAutoFillViewState extends State<CustomAutoFillView> {
  ...
  final SearchServicesImplementation searchServices = SearchServicesImplementation();
  Timer? _timer;
                    ...
                    child: Column(
                      children: [
                        SearchAutocompleteTextField(
                          ...
                          // },
                          onSubmit: () {
                            context.read<SearchViewModel>().addToHistory(searchKeyWord: _searchTextEditingController.text);
                          ...
                          child: _searchTextEditingController.text.isEmpty
                              ? SizedBox(
                                  ...
                                  child: ListView.builder(
                                    ...
                                    shrinkWrap: true,
                                    itemCount: context.watch<SearchViewModel>().getSearchHistory.length,
                                    itemBuilder: (context, index) {
                                      final element = context.read<SearchViewModel>().getSearchHistory[index];
                                      return InkWell(
                                        ...
                                        child: Container(
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              ...
                                              IconButton(
                                                  onPressed: () {
                                                    context.read<SearchViewModel>().removeFrmHistory(searchKeyWord: element);
                                                    setState(() {
                                                      isFocused = true;
                                                    });
                                                  },
                                  ...
                                  child: SizedBox(
                                      ...
                                      child: FutureBuilder(
                                          future: searchServices.getBlogOverviewList(
                                              categorySlug: _searchTextEditingController.text.isEmpty ? 'l' : _searchTextEditingController.text),
                                          builder: (context, snapshot) {
                                            if (snapshot.connectionState == ConnectionState.done) {
                                                                      ...
                                                                      children: [
                                                                        Row(
                                                                          ...
                                                                          children: [
                                                                            ...
                                                                            Text(
                                                                              DateFormat('MMM d, yyyy').format(l[index].createdAt),
                                                                            ),
                                                                          ],
                                                                        ),
                                                                        Text(
                                              ...
                                              return const Center(
                                                child: SizedBox(width: 30.0, child: CircularProgressIndicator()),
                                              );
                                            }
...
class CustomLocationWidget extends StatelessWidget {
  const CustomLocationWidget({super.key, required this.loctionType, required this.locationValue, required this.bRG, required this.height});
      ...
      ClipRRect(
        ...
        child: Container(
          ...
          decoration: const BoxDecoration(
              color: Colors.white,
              border: Border(
                top: BorderSide(color: Color.fromRGBO(202, 203, 206, 0.4), width: 1),
              )),
          child: Row(
